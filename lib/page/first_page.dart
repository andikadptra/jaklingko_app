                      ...
                      Padding(
                        ...
                        child: ElevatedButton(
                            ...
                            child: Container(
                              ...
                              height: 50,
                              child: Center(
                                child: Text('PILIH RUTE KENDARAAN'),
                              ),
                            )),
                      ),
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: ElevatedButton(
                                onPressed: () {
                                  setState(() {
                                    statusCar = 'MOBIL PERJALANAN PULANG';
                                  });
                                },
                                child: Container(
                                  width: widthScreen / 2.7,
                        ...
                        children: [
                          Padding(
                            ...
                            child: ElevatedButton(
                                onPressed: () async {
                                  print('object');
                                  // await speak("Halo, ini contoh text to speech dalam bahasa Indonesia");
                                  ...
                                  child: Container(
                                      ...
                                      child: Center(
                                        child: Text(
                                          'B10',
                                          style:
                                              myTextStyle(20, FontWeight.bold),
                                        ),
                                      )),
                                ),
                              ),
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text('STATUS : ${statusCar}',
                                        style:
                                            myTextStyle(16, FontWeight.w500)),
                                  ),
                                  Padding(
                                    padding: const EdgeInsets.all(2.0),
                                    child: Text('DISPLAY : ${displayText}',
                                        style:
                                            myTextStyle(16, FontWeight.w400)),
                                  ),
                                  Padding(
                                    padding: const EdgeInsets.all(2.0),
